    ...
    return (
        <div className='lg:ml-10 mt-24 lg:mt-10 bg-white text-[#000000] px-[40px] flex flex-col justify-center items-center lg:items-start'>
            ...
            <p className='text-[14px] mt-[15px] text-[#94a3b8] w-full text-center lg:text-left'>
                Already have an account? <Link href='/login'><span className='text-[#1ab479]'>Login</span></Link>
            </p>
            ...
            <form className='mt-[30px] flex flex-col items-center lg:items-start space-y-[16px] p-2 w-full'>
                ...
                <div className='flex items-center gap-x-2'>
                    <input type="checkbox" />
                    <p className='text-[0.8rem] md:text-[1rem]'>I agree to the <span className='text-[#1ab479]'>Terms & Conditions</span></p>
                </div>

                <button className='rounded-md bg-[#1ab479] px-[24px] py-[16px] border-none text-white w-full lg:w-[600px] h-[50px] box-border'> Create account</button>
            ...
            <div className='my-[24px] flex flex-col lg:flex-row justify-center lg:justify-start space-y-4 lg:space-y-0 lg:space-x-4 items-center w-full p-2'>
                <button className='w-full lg:w-[200px] rounded-lg flex items-center justify-center gap-x-2 h-[50px] border border-[#cbd5e1] bg-transparent'><Image src='/Symbol.png' alt='google' height={20} width={20} /> Google</button>
                <button className='w-full lg:w-[200px] rounded-lg flex items-center justify-center gap-x-2 h-[50px] border border-[#cbd5e1] bg-transparent'><Image src='/apple.png' alt='apple' height={20} width={20} /> Apple</button>
                <button className='w-full lg:w-[200px] rounded-lg flex items-center justify-center gap-x-2 h-[50px] border border-[#cbd5e1] bg-transparent'><Image src='/github.png' alt='google' height={20} width={20} /> Github</button>
            </div>
        </div>
    )
}
